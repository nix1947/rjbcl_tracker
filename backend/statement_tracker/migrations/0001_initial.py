# Generated by Django 5.2 on 2025-05-11 05:26
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('branch', models.CharField(choices=[('head_office', 'प्रधान कार्यलय'), ('chabahil', 'चाबहिल'), ('lagankhel', 'लगनखेल'), ('kalanki', 'कलंकी'), ('suryabinayak', 'सूर्यविनायक'), ('banepa', 'बनेपा'), ('biratnagar', 'विराटनगर'), ('birgunj', 'वीरगञ्ज'), ('pokhara', 'पोखरा'), ('butwal', 'बुटवल'), ('nepalgunj', 'नेपालगञ्ज'), ('dhangadhi', 'धनगढी'), ('hetauda', 'हेटौडा'), ('bhaktapur', 'भक्तपुर'), ('lalitpur', 'ललितपुर'), ('baglung', 'बागलुङ'), ('dhankuta', 'धनकुटा'), ('birtamod', 'बिर्तामोड'), ('narayangadh', 'नारायणगढ'), ('ghorahi', 'घोराही')], max_length=255)),
            ...
            options={
                ...
                'constraints': [models.UniqueConstraint(fields=('bank', 'bank_trans_id', 'system_voucher_no'), name='unique_bank_transaction')],
            },
        ),
    ]
